...
func getSensorValue(sensorId string) SensorDataRes {
	...
	if err2 != nil {
		fmt.Println("Error while fetching document from DB")
		os.Exit(1)
	}
	...
	if err3 != nil {
		fmt.Println("Error while updating document")
		os.Exit(1)
	}
...
func removeSensor(sensorId string) {
	...
	if err2 != nil {
		fmt.Println("Error while removing a sensor")
		os.Exit(1)
	}
...
func changeSensorStatus(sensorId string, status bool) SensorDataRes {
	...
	if err3 != nil {
		fmt.Println("Error while updating document in DB")
		os.Exit(1)
	}
	session.Close()
...
func getDatabaseURL() string {
	var dburl string = "mongodb://shikher9:mongo1239@ds033103.mlab.com:33103/sensordb"
	return dburl
}
